...
// Get the button that opens the modal (you can customize this or call the function directly)
window.onload = function() {
    setTimeout(function() {
        modal.style.display = "block";
    }, 500); // Show the modal after 3 seconds
}
...
document.getElementById("emailForm").addEventListener("submit", function(event) {
    ...
    xhr.send("company=" + encodeURIComponent(company) + "&email=" + encodeURIComponent(email));
});
